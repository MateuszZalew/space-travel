...
1. Clone the repository
   ```sh
   git clone https://github.com/MateuszZalew/space-travel.git
   ```
...
Project Link: [https://github.com/MateuszZalew/space-travel](https://github.com/MateuszZalew/space-travel)
